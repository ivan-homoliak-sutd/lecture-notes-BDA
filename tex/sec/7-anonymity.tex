...
\begin{figure}[t]
	...
	\begin{center}
		...
		\caption{Interactive zero-knowledge proof example of Alibaba cave Verifier has to repeat the query multiple times to decrease a chance of prover to guess it~\cite{Quisquater1990}.}		
		\label{fig:alibaba}
	\end{center}	
\end{figure}
