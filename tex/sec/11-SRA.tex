...
%	\vspace{-0.3cm}
\begin{center}
	\includegraphics[width=0.65\textwidth]{./figs/attacks-consensus-PoS.pdf}
...
\begin{figure}
	...
	\begin{center}
		...
		\caption{VTD graph of tokens and wallets category~\cite{homoliak2019security}.}		
...
\begin{figure}
	...
	\begin{center}
		...
		\caption{VTD graph of exchanges category~\cite{homoliak2019security}.}		
...
\begin{figure}
	...
	\begin{center}
		...
		\caption{VTD graph of oracles category~\cite{homoliak2019security}.}		
...
\begin{figure}
	...
	\begin{center}
		...
		\caption{VTD graph of decentralized filesystems~\cite{homoliak2019security}.}		
...
\begin{figure}
	%	\vspace{-0.3cm}
	\begin{center}
		\includegraphics[width=0.75\textwidth]{./figs/attacks-APP-evoting.pdf}
		\caption{VTD graph of e-voting category~\cite{homoliak2019security}.}		
		\label{fig:sra-app-DFs}
	\end{center}	
\end{figure}
