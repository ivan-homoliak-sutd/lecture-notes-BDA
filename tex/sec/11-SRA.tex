...
\tightlist
\item
  \textbf{Tokens}: All public cryptocurrencies are equipped with the native crypto-tokens. On the other hand smart contract platforms can have programmed tokens, such as fungible (ERC-20) and non-fungible (ERC-721) tokens -- they are essentially smart contracts that manage balances. They are  subject to all the standard smart contract vulnerabilities.
