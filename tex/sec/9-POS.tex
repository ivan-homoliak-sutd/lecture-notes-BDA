...
\begin{itemize}
	...
	%
	CoPoR-PoS~\cite{homoliak2025pos} proposed native embedding of the annonymization layer into the consesnus protocol itself.
...
\begin{figure}[b]
	%	\vspace{-0.3cm}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{./figs/tc1.png}
...
\textbf{Pros}: More general and powerful, with extra features
...
\begin{figure}[t]
	%	\vspace{-0.3cm}
	\begin{center}
		\includegraphics[width=0.5\textwidth]{./figs/TLSN.png}
