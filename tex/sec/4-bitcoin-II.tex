...
Nevertheless, this was not the case, as indicated by the study Hum et al~\cite{}\ih{citation} -- see \autoref{tab:clones}.
...
\begin{figure}
	...
	\caption{Bitcoin clones -- ratio of cloned code as of 2020.}\label{fig:btc-clones}
\end{figure}
