...
CBDC-Aquasphere is an example of Aquareum's application to the environment of CBDC instances -- each CBDC instance is represented by a single Aquareum instance -- see \autoref{}.
