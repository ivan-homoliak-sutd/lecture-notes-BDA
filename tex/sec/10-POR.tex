...
Scrypt~\cite{percival2009scrypt} is a \textbf{password-based key derivation function (PBKDF)} designed in
...
Argon2~\cite{biryukov2016argon2}, the winner of the 2015 Password Hashing Competition, is a more
...
\begin{figure}
	...
	\caption{The parallel and sequential modes of the Argon2 algorithm~\cite{biryukov2016argon2}.}\label{fig:argon2}
\end{figure}
...
A notable example is \textbf{PrimeCoin}~\cite{king2013primecoin}, which uses its mining process
...
Permacoin~\cite{miller2014permacoin} is a protocol designed to repurpose mining efforts for
