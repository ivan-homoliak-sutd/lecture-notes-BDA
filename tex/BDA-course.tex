...
\input{./sec/7-anonymity.tex}
\newpage

\section{Scalability and Throughput}\label{chapter-6-scalability}
\input{./sec/8-scalability.tex}
\newpage

\section{A Layered Security Model of Blockchain and Its Applications}\label{chapter-12-sra}
\input{./sec/11-SRA.tex}
\newpage
